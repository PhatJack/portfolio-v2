...
const ProjectItem = ({ img, title }: { img: string, title: string }) => {
	return (
		<div className="relative flex-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e] transition-all">
